...
# data "aws_subnets" "dublin_subnets" {
#   filter {
#     name   = "vpc-id"
#     values = [var.vpc_id]
#   }
...
# data "aws_subnet" "dublin_subnet" {
#   for_each = toset(data.aws_subnets.dublin_subnets.ids)
#   id       = each.value
# }

resource "aws_instance" "cdn-pop-dublin-a" {
  ...
  key_name = "nginx_openresty_dublin"
...
output "ec2_a_public_ip" {
  value = aws_instance.cdn-pop-dublin-a.public_ip
}

output "ec2_a_public_dns" {
  value = aws_instance.cdn-pop-dublin-a.public_dns
}


# # second instance in a pop

resource "aws_instance" "cdn-pop-dublin-b" {
...
output "ec2_b_public_ip" {
  value = aws_instance.cdn-pop-dublin-b.public_ip
}

output "ec2_b_public_dns" {
  value = aws_instance.cdn-pop-dublin-b.public_dns
}



# output "subnet_cidr_blocks" {
#   value = [for s in data.aws_subnet.dublin_subnet : s.cidr_block]
# }

data "aws_key_pair" "nginx_openresty_dublin" {
  key_name = "nginx_openresty_dublin"
...
# output "fingerprint" {
#   value = data.aws_key_pair.nginx_openresty_dublin.fingerprint
# }

# output "name" {
#   value = data.aws_key_pair.nginx_openresty_dublin.key_name
# }

# output "id" {
#   value = data.aws_key_pair.nginx_openresty_dublin.id
# }
